		    			...
		    			<div class="states-wrap">
		    				...
		    				<div class="row">
                                ...
                                foreach($states->result() as $state) {
                                    $state_img = (!file_exists(APPPATH.'../build/images/states/'.$state->abbrev.'.jpg')) ? base_url('build/images/states/stateholderthumb.jpg') : base_url('build/images/states/'.$state->abbrev.'.jpg');
		    					...
		    					<div class="col-md-4 col-sm-6">
		    						...
		    						<div class="states-item">
		    							...
		    							<a href="<?php echo base_url('industry/'.$industry.'/'.strtolower($state->abbrev)); ?>">
			    							...
			    							<div class="states-thumb">
			    								...
			    								<img class="img-responsive" src="<?php echo $state_img; ?>" alt="<?php echo $state->state; ?>" title="<?php echo $state->state; ?>" />
