...
<div class="state-content">
    ...
    <section class="section-header parallax" data-parallax="scroll" data-image-src="<?php echo base_url('build/images/states/'.$state->abbrev.'.jpg'); ?>">
		    				...
		    				<div class="city-item">
								...
								<div class="media item-wrap">
									...
									<div class="media-body details-right">
										...
										<a class="url" href="<?php echo base_url('city/'.$city->slug); ?>"><?php echo base_url('city/'.$city->slug); ?></a>
